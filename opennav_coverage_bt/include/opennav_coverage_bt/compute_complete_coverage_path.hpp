    ...
    return providedBasicPorts(
      {
        ...
        BT::InputPort<double>("swath_step_angle", 0.0, "Angle step for swath angle optimization"),
        BT::InputPort<std::string>("swath_mode", "SET_ANGLE", "Swath angle mode, e.g. SET_ANGLE, BRUTE_FORCE"),
        BT::InputPort<std::string>("swath_objective", "COVERAGE", "Objective for coverage, e.g. COVERAGE, LENGTH, NUMBER"),
